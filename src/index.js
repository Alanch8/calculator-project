...
var calculator_typescript_alanch8_1 = require("calculator-typescript-alanch8");
var calculator = new calculator_typescript_alanch8_1.Calculator();
...
do {
    ...
    switch (Number(userOption)) {
        ...
        case 3:
            ...
            number1 = input();
            number2 = input();
            console.log('The result is: ', calculator.multiply(Number(number1), Number(number2)));
            break;
        case 4:
            // tslint:disable-next-line:no-console
            console.log("Introduce two numbers");
